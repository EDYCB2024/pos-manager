...
export default function AllyInstapago() {
    ...
    const load = () => {
        setLoading(true);
        // Specifically filter by ally "INSTAPAGO"
        getDevicesPaged({ page, pageSize, search, filterCaso, filterRep, filterAliado: 'INSTAPAGO' }).then(({ data, count }) => {
            setDevices(data);
            setTotal(count || 0);
            setLoading(false);
        ...
        <div className="device-list anim-fadeUp">
            <div className="page-header">
                <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                    ...
                    <div>
                        <h1 className="page-title">Equipos Aliado Instapago</h1>
                        <p className="page-sub">
                            {total} equipo{total !== 1 ? 's' : ''} gestionado{total !== 1 ? 's' : ''} para INSTAPAGO
                        </p>
                    </div>
                </div>
                <div className="page-header__actions">
                    <button className="btn btn--minimal" onClick={() => navigate('/devices/new?mode=massive&aliado=INSTAPAGO')}>
                    ...
                    <button className="btn btn--minimal" onClick={() => navigate('/devices/new?aliado=INSTAPAGO')}>
            ...
            <div className="device-list__filters anim-fadeUp">
                <div className="search-box">
                    ...
                    <input
                        ...
                        type="text"
                        placeholder="Buscar en Instapago..."
                        value={search}
            ...
            {loading ? (
                <div className="empty-state anim-fadeIn">
                    ...
                    <p>Cargando tabla de INSTAPAGO...</p>
                </div>
            ) : devices.length === 0 ? (
                <div className="empty-state anim-fadeUp">
                    ...
                    <p>{search ? 'No hay resultados para esta búsqueda en INSTAPAGO.' : 'No hay casos registrados para INSTAPAGO.'}</p>
                </div>
            ) : (
                <>
