...
export default function AllyBancrecer() {
    ...
    const load = () => {
        setLoading(true);
        // Specifically filter by ally "BANCRECER"
        getDevicesPaged({ page, pageSize, search, filterCaso, filterRep, filterAliado: 'BANCRECER' }).then(({ data, count }) => {
            setDevices(data);
            setTotal(count || 0);
            setLoading(false);
        ...
        <div className="device-list anim-fadeUp">
            <div className="page-header">
                <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                    ...
                    <div>
                        <h1 className="page-title">Equipos Aliado Bancrecer</h1>
                        <p className="page-sub">
                            {total} equipo{total !== 1 ? 's' : ''} gestionado{total !== 1 ? 's' : ''} para BANCRECER
                        </p>
                    </div>
                </div>
                <div className="page-header__actions">
                    <button className="btn btn--minimal" onClick={() => navigate('/devices/new?mode=massive&aliado=BANCRECER')}>
                    ...
                    <button className="btn btn--minimal" onClick={() => navigate('/devices/new?aliado=BANCRECER')}>
            ...
            <div className="device-list__filters anim-fadeUp">
                <div className="search-box">
                    ...
                    <input
                        ...
                        type="text"
                        placeholder="Buscar en Bancrecer..."
                        value={search}
            ...
            {loading ? (
                <div className="empty-state anim-fadeIn">
                    ...
                    <p>Cargando tabla de BANCRECER...</p>
                </div>
            ) : devices.length === 0 ? (
                <div className="empty-state anim-fadeUp">
                    ...
                    <p>{search ? 'No hay resultados para esta búsqueda en BANCRECER.' : 'No hay casos registrados para BANCRECER.'}</p>
                </div>
            ) : (
                <>
