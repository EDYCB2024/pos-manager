...
export default function AllyPlatcoPos() {
    ...
    const load = () => {
        setLoading(true);
        // Specifically filter by ally "PLATCO POS"
        getDevicesPaged({ page, pageSize, search, filterCaso, filterRep, filterAliado: 'PLATCO POS' }).then(({ data, count }) => {
            setDevices(data);
            setTotal(count || 0);
            setLoading(false);
        ...
        <div className="device-list anim-fadeUp">
            <div className="page-header">
                ...
                <div className="page-header__actions">
                    <button className="btn btn--minimal" onClick={() => navigate('/devices/new?mode=massive&aliado=PLATCO POS')}>
                    ...
                    <button className="btn btn--minimal" onClick={() => navigate('/devices/new?aliado=PLATCO POS')}>
            ...
            <div className="device-list__filters anim-fadeUp">
                <div className="search-box">
                    ...
                    <input
                        ...
                        type="text"
                        placeholder="Buscar en Platco Pos..."
                        value={search}
            ...
            {loading ? (
                <div className="empty-state anim-fadeIn">
                    ...
                    <p>Cargando casos de PLATCO POS...</p>
                </div>
            ) : devices.length === 0 ? (
