...
import './shared.css';
import bancaribeLogo from '../assets/bancaribe-logo.png';

export default function AllyBancaribe() {
    ...
    const load = () => {
        setLoading(true);
        // Specifically filter by ally "BANCARIBE"
        getDevicesPaged({ page, pageSize, search, filterCaso, filterRep, filterAliado: 'BANCARIBE' }).then(({ data, count }) => {
            setDevices(data);
            setTotal(count || 0);
            setLoading(false);
        ...
        <div className="device-list anim-fadeUp">
            <div className="page-header">
                <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                    <div style={{ 
                        ...
                        <img src={bancaribeLogo} alt="Bancaribe" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
                    </div>
                    <div>
                        <h1 className="page-title">Equipos Aliado Bancaribe</h1>
                        <p className="page-sub">
                            {total} equipo{total !== 1 ? 's' : ''} gestionado{total !== 1 ? 's' : ''} para BANCARIBE
                        </p>
                    </div>
                </div>
                <div className="page-header__actions">
                    <button className="btn btn--secondary" onClick={() => navigate('/devices/new?mode=massive&aliado=BANCARIBE')}>
                    ...
                    <button className="btn btn--primary" onClick={() => navigate('/devices/new?aliado=BANCARIBE')}>
            ...
            <div className="device-list__filters anim-fadeUp">
                <div className="search-box">
                    ...
                    <input
                        ...
                        type="text"
                        placeholder="Buscar en Bancaribe..."
                        value={search}
            ...
            {loading ? (
                <div className="empty-state anim-fadeIn">
                    ...
                    <p>Cargando tabla de BANCARIBE...</p>
                </div>
            ) : devices.length === 0 ? (
                <div className="empty-state anim-fadeUp">
                    ...
                    <p>{search ? 'No hay resultados para esta búsqueda en BANCARIBE.' : 'No hay casos registrados para BANCARIBE.'}</p>
                </div>
            ) : (
                <>
