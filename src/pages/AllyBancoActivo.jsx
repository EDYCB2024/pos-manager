        ...
        <div className="device-list anim-fadeUp">
            <div className="page-header">
                ...
                <div className="page-header__actions">
                    <button className="btn btn--secondary" onClick={() => navigate('/devices/new?mode=massive&aliado=BANCO ACTIVO')}>
                    ...
                    <button className="btn btn--primary" onClick={() => navigate('/devices/new?aliado=BANCO ACTIVO')}>
            ...
            <div className="device-list__filters anim-fadeUp">
                <div className="search-box">
                    ...
                    <input
                        ...
                        type="text"
                        placeholder="Buscar en Banco Activo..."
                        value={search}
            ...
            {loading ? (
                <div className="empty-state anim-fadeIn">
                    ...
                    <p>Cargando tabla de BANCO ACTIVO...</p>
                </div>
            ) : devices.length === 0 ? (
                <div className="empty-state anim-fadeUp">
                    ...
                    <p>{search ? 'No hay resultados para esta búsqueda en BANCO ACTIVO.' : 'No hay casos registrados para BANCO ACTIVO.'}</p>
                </div>
            ) : (
                <>
