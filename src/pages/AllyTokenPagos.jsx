...
export default function AllyTokenPagos() {
    ...
    const load = () => {
        setLoading(true);
        // Specifically filter by ally "TOKEN PAGOS"
        getDevicesPaged({ page, pageSize, search, filterCaso, filterRep, filterAliado: 'TOKEN PAGOS' }).then(({ data, count }) => {
            setDevices(data);
            setTotal(count || 0);
            setLoading(false);
        ...
        <div className="device-list anim-fadeUp">
            <div className="page-header">
                <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                    ...
                    <div>
                        <h1 className="page-title">Equipos Aliado Token Pagos</h1>
                        <p className="page-sub">
                            {total} equipo{total !== 1 ? 's' : ''} gestionado{total !== 1 ? 's' : ''} para TOKEN PAGOS
                        </p>
                    </div>
                </div>
                <div className="page-header__actions">
                    <button className="btn btn--minimal" onClick={() => navigate('/devices/new?mode=massive&aliado=TOKEN PAGOS')}>
                    ...
                    <button className="btn btn--minimal" onClick={() => navigate('/devices/new?aliado=TOKEN PAGOS')}>
            ...
            <div className="device-list__filters anim-fadeUp">
                <div className="search-box">
                    ...
                    <input
                        ...
                        type="text"
                        placeholder="Buscar en Token Pagos..."
                        value={search}
            ...
            {loading ? (
                <div className="empty-state anim-fadeIn">
                    ...
                    <p>Cargando tabla de TOKEN PAGOS...</p>
                </div>
            ) : devices.length === 0 ? (
                <div className="empty-state anim-fadeUp">
                    ...
                    <p>{search ? 'No hay resultados para esta búsqueda en TOKEN PAGOS.' : 'No hay casos registrados para TOKEN PAGOS.'}</p>
                </div>
            ) : (
                <>
