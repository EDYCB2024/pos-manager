...
export default function AllyVatc() {
    ...
    const load = () => {
        setLoading(true);
        // Specifically filter by ally "VAT&C"
        getDevicesPaged({ page, pageSize, search, filterCaso, filterRep, filterAliado: 'VAT&C' }).then(({ data, count }) => {
            setDevices(data);
            setTotal(count || 0);
            setLoading(false);
            ...
            <div className="page-header">
                <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                    <div style={{ 
                        ...
                        <img src={vatcLogo} alt="VAT&C" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
                    </div>
                    <div>
                        <h1 className="page-title">Equipos Aliado VAT&C</h1>
                        <p className="page-sub">
                            {total} equipo{total !== 1 ? 's' : ''} gestionado{total !== 1 ? 's' : ''} para VAT&C
                        </p>
                    </div>
                </div>
            ...
            <div className="device-list__filters anim-fadeUp">
                <div className="search-box">
                    ...
                    <input
                        ...
                        type="text"
                        placeholder="Buscar por serial, RIF, factura, modelo..."
                        value={search}
