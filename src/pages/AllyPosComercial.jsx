...
import './DeviceList.css'; // Reuse common styles
import './shared.css';

export default function AllyPosComercial() {
    ...
    const load = () => {
        setLoading(true);
        // Specifically filter by ally "POSCOMERCIAL"
        getDevicesPaged({ page, pageSize, search, filterCaso, filterRep, filterAliado: 'POSCOMERCIAL' }).then(({ data, count }) => {
            setDevices(data);
            setTotal(count || 0);
            setLoading(false);
        ...
        <div className="device-list anim-fadeUp">
            <div className="page-header">
                <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                    ...
                    <div>
                        <h1 className="page-title">Equipos Aliado PosComercial</h1>
                        <p className="page-sub">
                            {total} equipo{total !== 1 ? 's' : ''} gestionado{total !== 1 ? 's' : ''} para POSCOMERCIAL
                        </p>
                    </div>
                </div>
                <div className="page-header__actions">
                    <button className="btn btn--minimal" onClick={() => navigate('/devices/new?mode=massive&aliado=POSCOMERCIAL')}>
                    ...
                    <button className="btn btn--minimal" onClick={() => navigate('/devices/new?aliado=POSCOMERCIAL')}>
            ...
            <div className="device-list__filters anim-fadeUp">
                <div className="search-box">
                    ...
                    <input
                        ...
                        type="text"
                        placeholder="Buscar en POSCOMERCIAL..."
                        value={search}
            ...
            {loading ? (
                <div className="empty-state anim-fadeIn">
                    ...
                    <p>Cargando tabla de POSCOMERCIAL...</p>
                </div>
            ) : devices.length === 0 ? (
                <div className="empty-state anim-fadeUp">
                    ...
                    <p>{search ? 'No hay resultados para esta búsqueda en POSCOMERCIAL.' : 'No hay casos registrados para POSCOMERCIAL.'}</p>
                </div>
            ) : (
                <>
