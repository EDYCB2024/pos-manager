...
export default function AllyDelSur() {
    ...
    const load = () => {
        setLoading(true);
        // Specifically filter by ally "DEL SUR"
        getDevicesPaged({ page, pageSize, search, filterCaso, filterRep, filterAliado: 'DEL SUR' }).then(({ data, count }) => {
            setDevices(data);
            setTotal(count || 0);
            setLoading(false);
        ...
        <div className="device-list anim-fadeUp">
            <div className="page-header">
                <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                    ...
                    <div>
                        <h1 className="page-title">Equipos Aliado Del Sur</h1>
                        <p className="page-sub">
                            {total} equipo{total !== 1 ? 's' : ''} gestionado{total !== 1 ? 's' : ''} para DEL SUR
                        </p>
                    </div>
                </div>
                <div className="page-header__actions">
                    <button className="btn btn--minimal" onClick={() => navigate('/devices/new?mode=massive&aliado=DEL SUR')}>
                    ...
                    <button className="btn btn--minimal" onClick={() => navigate('/devices/new?aliado=DEL SUR')}>
            ...
            {loading ? (
                ...
                <div className="empty-state anim-fadeUp">
                    ...
                    <p>{search ? 'No hay resultados para esta búsqueda en DEL SUR.' : 'No hay casos registrados para DEL SUR.'}</p>
                </div>
            ) : (
                <>
