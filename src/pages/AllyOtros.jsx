...
export default function AllyOtros() {
    ...
    const load = () => {
        setLoading(true);
        // Specifically filter by ally "OTROS"
        getDevicesPaged({ page, pageSize, search, filterCaso, filterRep, filterAliado: 'OTROS' }).then(({ data, count }) => {
            setDevices(data);
            setTotal(count || 0);
            setLoading(false);
        ...
        <div className="device-list anim-fadeUp">
            <div className="page-header">
                <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
                    ...
                    <div>
                        <h1 className="page-title">Equipos Otros Aliados</h1>
                        <p className="page-sub">
                            {total} equipo{total !== 1 ? 's' : ''} gestionado{total !== 1 ? 's' : ''} para OTROS
                        </p>
                    </div>
                </div>
                <div className="page-header__actions">
                    <button className="btn btn--minimal" onClick={() => navigate('/devices/new?mode=massive&aliado=OTROS')}>
                    ...
                    <button className="btn btn--minimal" onClick={() => navigate('/devices/new?aliado=OTROS')}>
            ...
            {loading ? (
                ...
                <div className="empty-state anim-fadeUp">
                    ...
                    <p>{search ? 'No hay resultados para esta búsqueda en OTROS.' : 'No hay casos registrados para OTROS.'}</p>
                </div>
            ) : (
                <>
